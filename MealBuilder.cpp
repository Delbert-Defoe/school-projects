//This program will build a random meal, based on the course selected
#include <iostream>
#include <windows.h>
...
//this block of code prevents you from having more than one chickens in your lunch
if(b==5 || b==6 && d==5 || d==6 || d==8){
...
//this block of code prevents you from having apple pudding and apple fruit in the same meal
if(a==1 && c==0){

 c= c+1;

}
//this block of code prevents you from having more than one chickens in your dinner
if(b==5 || b==6 && d==5 || d==6 || d==8){
